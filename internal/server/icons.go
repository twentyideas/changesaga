...
const uiIconSymbols = `` +
	...
	`<symbol id="i-diff" viewBox="0 0 16 16"><path d="M1.5 8h5M4 5.5v5" fill="none" stroke="var(--green,#1a7f37)" stroke-width="1.9" stroke-linecap="round"/><path d="M9.5 8h5" fill="none" stroke="var(--red,#cf222e)" stroke-width="1.9" stroke-linecap="round"/></symbol>` +
	...
	`<symbol id="i-approve" viewBox="0 0 16 16"><circle cx="8" cy="8" r="5.7" fill="none" stroke="currentColor" stroke-width="1.4"/><path d="m5 8.2 2 2 4.1-4.3" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></symbol>` +
	`<symbol id="i-approve-filled" viewBox="0 0 16 16"><circle cx="8" cy="8" r="6" fill="currentColor"/><path d="m5 8.2 2 2 4.1-4.3" fill="none" stroke="#fff" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></symbol>` +
	`<symbol id="i-reject" viewBox="0 0 16 16"><circle cx="8" cy="8" r="5.7" fill="none" stroke="currentColor" stroke-width="1.4"/><path d="m5.8 5.8 4.4 4.4m0-4.4-4.4 4.4" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></symbol>` +
	`<symbol id="i-reject-filled" viewBox="0 0 16 16"><circle cx="8" cy="8" r="6" fill="currentColor"/><path d="m5.8 5.8 4.4 4.4m0-4.4-4.4 4.4" fill="none" stroke="#fff" stroke-width="1.6" stroke-linecap="round"/></symbol>` +
